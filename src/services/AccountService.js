export function getListAccounts() {
  ...
  export const updateURL = "https://my-account-service.herokuapp.com/Account/update";
  ...
  export function enabledAccount(id) {
   ...
   fetch('https://my-account-service.herokuapp.com/Account/enable', requestOptions)
  ...
  export function disabledAccount(id) {
   ...
   fetch('https://my-account-service.herokuapp.com/Account/disable', requestOptions)
      .then(response => response.json());
