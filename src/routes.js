...
const routes = [
  ...
  { path: '/card', name: 'Add card', component: CardForm ,private: true},
  ...
  { path: '/agencies', name: 'agencies-list', component: AgenciesList, },
  { path: '/agency', name: 'Add agency', component: AgencyForm, },
